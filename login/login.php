...
if($_SERVER['REQUEST_METHOD'] == "POST"){//post - to collect value of input field
    if(empty(trim($_POST['username'])))//if the username is empty
    {
    ...
    if(empty($username_err) && empty($password_err))//if no error is there
    {
...
.btn-primary{
  ...
  <body>
    <nav class="navbar navbar-expand-lg ">
      <!--expand for resp collapsing and color schemes -->
      <a class="navbar-brand" href="#">Being Ambivert! </a
      ><!--for your  product, or project name. -->
      <button
